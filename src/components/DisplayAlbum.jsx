    ...
    <>
      ...
      <div className="mt-10 flex gap-8 flex-col md:flex-row md:items-end">
        ...
        <div className="flex flex-col">
            ...
            <p className='mt-1'>
                <img className='inline-block h-10' src={assets.spotify_logo}></img>
                <b>Spotify </b>
                 1,234,45 likes 
                <b>     50 songs </b>
                about 2hr 30min
      ...
      <hr />
        {
            ...
            <div onClick={()=>playWithId(item.id)} key={index} className="grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-center hover:bg-[#ffffff26] cursor-pointer">
                <p>
